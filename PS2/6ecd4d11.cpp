//---------------------------------------------------------------------------------------
// cut-scene_6a
// Date 20/10/2004, Time 21:25:4
// Martin Fuller: Automatically Produced By ALE Editor
//---------------------------------------------------------------------------------------
#ifndef __CUT_SCENE_6A_H__
#define __CUT_SCENE_6A_H__
    ...
    #define ANIM_CROCKETT_DRIVING_9366                                         9366
    #define ANIM_TUBBS_DRIVING_9367                                            9367
    #define ANIM_WALK_3003                                                     3003
    #define ANIM_CROCKETT_TALKING_9368                                         9368
    #define ANIM_TUBBS_TALKING_9369                                            9369
    #define ANIM_SIT_3007                                                      3007
    #define ANIM_MALE_SITTING_9394                                             9394

    #define SOUND_DATA_DAYTONA_PULL_UP_AND_STOP                                0xd5198529
    #define SOUND_DATA_DAYTONA_START_AND_OFF                                   0x9301364b
    ...
    #define TEXTURE_SKIN_SPEC_021                                              0xe1cd0ef4 	// Geometry Texture, 
    ...
    #define TEXTURE_BIKINI_BRIEFS05                                            0xa048afa 	// Geometry Texture, 
    #define TEXTURE_MV_GS_GENERIC_FULL_ARM01B                                  0xca7c4562 	// Geometry Texture, 
    #define TEXTURE_MV_GS_GENERIC_FOOT01FB                                     0xd6e59c5b 	// Geometry Texture, 
    #define TEXTURE_MV_GS_GENERIC_BODY01FB                                     0xb3010f9a 	// Geometry Texture, 
    #define TEXTURE_MV_GS_GENERIC_LEG01FB                                      0xe1d1be03 	// Geometry Texture, 
    ...
    #define TEXTURE_SKIN_SPEC_0211                                             0x741500f 	// Geometry Texture, 
    ...
    #define GEOMETRY_ESPRIT_WH                                                 0x9cadd043
    #define GEOMETRY_PORSCHE911_WH                                             0xe4f08d1c
    #define GEOMETRY_PORSCHE911_WH2                                            0xcab37221
    #define GEOMETRY_ESPRIT_WH2                                                0x2742def
    #define GEOMETRY_BIKINI_TIGER01B                                           0x47b2a4f3
    ...
    #define FX_CARSMOKE                                                        0xe864810d

    #define TIMELINE_INSTANCE_CUT_SCENE_6A                                     0x423c175b
    ...
    // Hull: road 6
    #define FX_INSTANCE_CARSMOKE                                               0xe864810d
    #define FX_INSTANCE_CARSMOKE_COPY_1                                        0x2fdc272e
    ...
    // Hull: road 6
    #define INSTANCE_DAYTONA_6A                                                0xc3a2d8d8
    #define INSTANCE_CROCKETT_SKIN_2                                           0x4536a668
    #define INSTANCE_TUBBS_BODY5                                               0x85b38f08
    #define INSTANCE_CB_RADIO_HANDSET                                          0x6f96d119
    #define INSTANCE_ESPRIT_WH                                                 0xb1c3666a
    #define INSTANCE_PORSCHE911_WH                                             0xc67881fc
    #define INSTANCE_PORSCHE911_WH2                                            0xe23d7bd8
    #define INSTANCE_ESPRIT_WH2                                                0xa729a43e
    #define INSTANCE_BIKINI_TIGER01B                                           0xc800180c
    ...
    #define INSTANCE_SHADOW_GENERIC                                            0xe850a46a

    // Hull: skydome Hull
    #define INSTANCE_GENERIC_HEAD03                                            0xc4e5ee59

    // Hull: road 6
    #define SFX_POINT_DAYTONA_PULL_UP_AND_STOP                                 0x4aca5630
    #define SFX_POINT_DAYTONA_START_AND_OFF                                    0xb85dd198
