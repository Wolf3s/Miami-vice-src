//---------------------------------------------------------------------------------------
// AV_DrugDealer
// Date 20/10/2004, Time 21:19:19
// Martin Fuller: Automatically Produced By ALE Editor
//---------------------------------------------------------------------------------------
#ifndef __AV_DRUGDEALER_H__
#define __AV_DRUGDEALER_H__
    ...
    #define TEXTURE_MV_GS_DRUG_DEALERS                                         0x7d68382c 	// Geometry Texture, 
    #define TEXTURE_MV_GS_DRUG_DEALER_SUITARM01                                0x97eef2f6 	// Geometry Texture, 
    ...
    #define TEXTURE_MV_JB_DRUGDEALERSHIRT02                                    0x88f4385 	// Geometry Texture, 
    #define TEXTURE_MV_GS_DRUG_FACED                                           0xdb8f8dfd 	// Geometry Texture, 
    #define TEXTURE_MOUTH_TEETH                                                0xc1452e3c 	// Geometry Texture, 
    #define TEXTURE_MV_GS_DRUG_SHOES01                                         0x6e4a9dbd 	// Geometry Texture, 
    #define TEXTURE_MV_JB_DRUGDEALERTROU02                                     0xaf5036de 	// Geometry Texture, 
    #define TEXTURE_EYE_GREEN                                                  0x1b4ff61b 	// Geometry Texture, 
    #define TEXTURE_TESTSHADER01                                               0x79f152a0 	// Geometry Texture, 
    #define TEXTURE_EYEBL                                                      0x34adfb96 	// Geometry Texture, 
    #define TEXTURE_MV_GS_DRUG_DEALERSJTOP                                     0xee3279a1 	// Geometry Texture, 
    #define TEXTURE_MV_JB_DRUGDEALERSHIRT01                                    0xa987b67d 	// Geometry Texture, 
    #define TEXTURE_MV_GS_DRUG_FACEJ                                           0x72570323 	// Geometry Texture, 
    #define TEXTURE_MV_GS_DRUG_SHOES02                                         0x35bf79dd 	// Geometry Texture, 
    #define TEXTURE_MV_GS_DRUG_DEALERJHAIRA                                    0x50796256 	// Geometry Texture, 
    #define TEXTURE_MV_GS_DRUG_DEALERJRING                                     0xa040cc17 	// Geometry Texture, 
    #define TEXTURE_REFLECT_SHINY_STRIPE_MOD                                   0x918dacd8 	// Geometry Texture, 
    ...
    #define GEOMETRY_DRUG_DEALERD                                              0x37a652a0
    #define GEOMETRY_DRUG_DEALERJ                                              0x15ceb81d
    #define GEOMETRY_MESH_BASE                                                 0x7afd8b6e

    #define HULL_HULL                                                          0xca421ad4

    // Hull: Hull
    #define INSTANCE_DRUG_DEALERD                                              0x3ff5f7f5
    #define INSTANCE_DRUG_DEALERJ                                              0x37b57ff
